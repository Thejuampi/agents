...
\begin{enumerate}
  ...
  \item An evaluation over 854 real closings from 66 sessions, including an
        ablation of each lane against that label (Section~\ref{sec:results}).
...
with the user's next message. This yields 854 pairs.
