...
\midrule
\texttt{corpus.py} & builds the labelled corpus; \texttt{--patterns} re-scores the pattern lane alone, keeping the stored verdicts & Table~\ref{tab:clean} inputs \\
...
The corpus builder takes about 13 minutes over 764 closings on a consumer GPU,
